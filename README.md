...
The notebook "coralreef-analysis.ipynb" contains the BINN implementation for the example data from Lady Musgrove Island, which is saved as "CoralReef-Data.xlsx".
