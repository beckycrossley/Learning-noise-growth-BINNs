...
For more information, see the associated manuscript: "A likelihood-based framework for learning heteroscedastic noise and growth dynamics using biologically-informed neural networks" by Rebecca M. Crossley and Ruth E. Baker.
